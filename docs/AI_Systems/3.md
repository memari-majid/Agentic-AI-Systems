...
- [Memory Systems for AI Agents](https://arxiv.org/abs/2307.05326) - Research paper on vector-based memory for agents
- [LangChain: Building Applications with LLMs](https://python.langchain.com/docs/get_started/introduction) - Framework for building agent components
- [A Survey on Large Language Model based Autonomous Agents](https://arxiv.org/abs/2308.11432) - Comprehensive review of agent components
- [RAG (Retrieval-Augmented Generation)](https://www.pinecone.io/learn/retrieval-augmented-generation/) - Guide to implementing memory-enhanced agents
- [What Are Embeddings?](https://vickiboykis.com/what_are_embeddings/) - Accessible explanation of vector embeddings for agent memory
- [Chroma Vector Database](https://www.trychroma.com/) - Open source embedded vector database for agent memory systems
- [Multi-modal Perception in AI](https://huggingface.co/blog/multimodal-llms) - Overview of combining text, vision, and audio inputs
- [Decision Theory for Agents](https://plato.stanford.edu/entries/decision-theory/) - Stanford Encyclopedia of Philosophy entry on decision-making frameworks
- [Reinforcement Learning: An Introduction](http://incompleteideas.net/book/the-book-2nd.html) - Sutton and Barto's textbook on RL for agent learning